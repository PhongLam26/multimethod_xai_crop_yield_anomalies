...
\label{tab:stability}
\scriptsize
\resizebox{\columnwidth}{!}{\input{../../../paper/generated/table_selection_stability.tex}}
\end{table}
...
\label{tab:event}
\scriptsize
\resizebox{\textwidth}{!}{\input{../../../paper/generated/table_event_detection.tex}}
\end{table*}
...
\label{tab:gateab}
\scriptsize
\resizebox{\textwidth}{!}{\input{../../../paper/generated/table_gate_ab.tex}}
\end{table*}
...
\footnotesize
\renewcommand{\arraystretch}{1.08}
\input{../../../paper/generated/table_robustness.tex}
\end{table*}
...
\scriptsize
\resizebox{\textwidth}{!}{\input{../../../paper/generated/table_resampling_sensitivity.tex}}
\end{table*}
...
\scriptsize
\resizebox{\textwidth}{!}{\input{../../../paper/generated/table_temporal_capacity.tex}}
\end{table*}
...
\label{tab:trace}
\scriptsize
\resizebox{\columnwidth}{!}{\input{../../../paper/generated/table_audit_traceability.tex}}
\end{table}
...
weather-only ExtraTrees residual model. On the untouched 2022--2025 holdout,
its RMSE was 13.47 versus 13.78 bushels per acre for the zero-residual baseline,
but the paired year-block 95\% CI for the difference was $[-0.67,0.26]$.
Gate A therefore remains inconclusive, and the county workflow emits
\textsc{Abstain}. This is an additional reproducible agricultural abstention
case, not a successful agricultural prediction result or evidence of transfer.
...
metadata. Gate A and Gate B1 fail. A separately locked county-level winter-wheat
panel also remains inconclusive under Gate A, despite a favorable point estimate.
Accordingly,
