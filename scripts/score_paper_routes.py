...
def main() -> None:
 ...
 external_points=10 if external['gate_a_status']=='PASS' and external['gate_b1_status']=='PASS' and external['explanation_availability']=='INTERPRET' else 0
 rows=[
  ...
  {'route':'Fidelity-gated XAI method benchmark','scientific_validity':18,'predictive_or_method':18,'applied_value':8,'novelty':13,'external_validation':external_points,'reproducibility':10,'writing_clarity':8,'status':'CANDIDATE','reason':'Synthetic benchmark passes; V1 abstains; EIA external Gate A and Gate B1 pass.'},
